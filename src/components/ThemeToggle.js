...
const ThemeToggle = () => {
    ...
    return (
      <button
        ...
        className="flex items-center justify-center w-10 p-2 mr-2 text-gray-600 bg-white border rounded-lg lg:bg-transparent dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-500 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 lg:dark:bg-transparent lg:border-0 dark:border-transparent"
      >
        {colorTheme === "light" ? (
          <svg
