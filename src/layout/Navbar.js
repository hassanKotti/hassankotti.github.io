          ...
          <div className='relative  w-full px-4 pt-4 pb-3 mx-auto block z-50'>
            <nav
              ...
              <div className='justify-around hidden w-full px-5 py-3 font-medium text-center text-indigo-600 md:justify-end md:flex md:items-center'>
                <a
                  href='https://github.com/hassankotti'
                  className='flex items-center justify-center w-10 p-2 mr-2 text-stone-600 bg-white border rounded-lg lg:bg-transparent hover:text-stone-600   focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500  lg:border-0'>
                  <svg
