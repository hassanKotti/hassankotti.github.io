...
const Education = () => {
  return (
    <section
      ...
      <h3 class='py-6 px-8 mx-auto sm:px-12 lg:px-20 z-10 text-3xl font-extrabold leading-8  uppercase text-stone-900  sm:text-5xl lg:text-6xl tracking-tight text-center'>
        EDUCATION
      </h3>
