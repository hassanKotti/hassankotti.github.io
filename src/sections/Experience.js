...
const Experience = () => {
  return (
    <section
      className='relative max-w-8xl  text-left  border-t-2 border-gray-200 snap-start snap-always'
      id='experience'>
      <div className='min-h-screen  py-6 flex flex-col justify-center relative overflow-hidden sm:py-12'>
        ...
        <div className='md:grid-cols-2 grid place-content-center place-items-center gap-6 md:justify-center relative overflow-hidden sm:py-12'>
          <div className='bg-white border shadow-lg rounded-lg py-5 px-6 relative code-editor'>
